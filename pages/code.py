...
# st.markdown("""
# Use the tabs below to explore the training code used for each model (CatBoost, XGBoost, LightGBM).
# """)

# # Define tabs
# catboost_tab, xgboost_tab, lightgbm_tab = st.tabs(["🐱 CatBoost", "🌲 XGBoost", "💡 LightGBM Ensemble"])
...
#             yticklabels=['↓ Decrease', '= Same', '↑ Increase'])
...
# print(f"\n📊 Classification Report for {industry}:\n")
# print(classification_report(y_test_decoded, y_pred_decoded, digits=2))
...
#             xticklabels=['↓ Decrease', '= Same', '↑ Increase'],
#             yticklabels=['↓ Decrease', '= Same', '↑ Increase'])
# plt.title(f"Confusion Matrix for {industry} (LightGBM Ensemble)")
# plt.xlabel("Predicted")
# plt.ylabel("Actual")
# plt.tight_layout()
# plt.show()
...
#     st.markdown("""XGBoost is a gradient boosting framework that excels on structured/tabular data. It’s widely used in Kaggle competitions for its speed, regularization capabilities, and scalability.""")
#     st.code("""
